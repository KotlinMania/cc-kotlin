...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Cc.swiftmodule/`
...
//      `import Cc` above would fail at compile time.
//
//   2. The static archive `libCc.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Cc" }` and
//      `flattenPackage = "io.github.kotlinmania.cc"` configuration in
