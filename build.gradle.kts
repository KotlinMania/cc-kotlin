...
kotlin {
    ...
    val xcf = XCFramework("Cc")

    macosArm64 {
        binaries.framework { baseName = "Cc"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Cc"
    ...
    swiftExport {
        moduleName = "Cc"
        flattenPackage = "io.github.kotlinmania.cc"
    }

    android {
        namespace = "io.github.kotlinmania.cc"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "cc-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/cc-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/cc-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/cc-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.cc.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleCcXCFramework",
    "assembleCcDebugXCFramework",
    "assembleCcReleaseXCFramework",
    "assembleDebugIosFatFrameworkForCcXCFramework",
    "assembleReleaseIosFatFrameworkForCcXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForCcXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForCcXCFramework",
    "assembleDebugMacosFatFrameworkForCcXCFramework",
    "assembleReleaseMacosFatFrameworkForCcXCFramework",
    "assembleDebugTvosFatFrameworkForCcXCFramework",
    "assembleReleaseTvosFatFrameworkForCcXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForCcXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForCcXCFramework",
    "assembleDebugWatchosFatFrameworkForCcXCFramework",
    "assembleReleaseWatchosFatFrameworkForCcXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForCcXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForCcXCFramework",
