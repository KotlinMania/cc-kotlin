...
This file is the quick-reference operating contract for cc-kotlin. The longer
...
cc-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`cc`](https://crates.io/crates/cc). Upstream Rust is the behavioral oracle while the
